    ...
    return (
        <Command className=''>
            ...
            <CommandGroup heading={t("display")}>
                <CommandItem onSelect={() => {setOpen(false); setTheme('system')}}>{t("systemdefault")}</CommandItem>
                <CommandItem onSelect={() => {setOpen(false); setTheme('dark')}}>{t("darkmode")}</CommandItem>
                <CommandItem onSelect={() => {setOpen(false); setTheme('light')}}>{t("lightmode")}</CommandItem>
            </CommandGroup>     
            <CommandSeparator />
